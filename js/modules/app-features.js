...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 1.5 Performance and Accessibility Modes
    initPerformanceMode(
    ...
    const openSkillModal = (skillName, triggerElement) => {
        ...
        skillModalDesc.innerHTML = `<p>${currentLang === 'en' ? details.en : details.fr}</p>`;
        ...
        function renderSearchResults(query) {
            ...
            matches.forEach(p => {
                ...
                item.addEventListener('click', () => {
                    toggleSearch(false);
                    openModal(parseInt(p.id, 10) - 1, item);
                });
    ...
    runWhenIdle(() => initGitHubStats(), 2200);
